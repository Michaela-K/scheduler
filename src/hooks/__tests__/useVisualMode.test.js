...
const FIRST = "FIRST";  //mode constant called FIRST to test that we could successfully set an initial state. 
const SECOND = "SECOND";  //To test the "transition" functionality, to assert that the hook can successfully transition from FIRST to SECOND.
const THIRD = "THIRD";
...
//then transition to SECOND and then check to see what the current value of mode is.
